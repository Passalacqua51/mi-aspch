...
assert.ok(app.includes('unlockedUntil')&&app.includes("sessionStorage.removeItem('miAspchUnlocked')"),'El boot debe respetar la ventana unlocked_until y limpiar el marcador local vencido');
