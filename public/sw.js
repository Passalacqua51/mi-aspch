const CACHE='mi-aspch-v0.6.16-informatica-b3753bcd';
const STATIC=['/','/informatica','/index.html','/admin.html','/styles.css','/app.js','/manifest.webmanifest','/logo-aspch-original.png','/icon-192.png','/icon-512.png','/apple-touch-icon.png'];
