const CACHE='mi-aspch-v0.6.16-parking-confirm-icon-71d43c9a';
const STATIC=['/','/index.html','/styles.css','/app.js','/manifest.webmanifest','/logo-aspch-original.png','/icon-192.png','/icon-512.png','/apple-touch-icon.png'];
