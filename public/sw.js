const CACHE='mi-aspch-v0.6.16-preview-admin-duration-e5ea3564';
const STATIC=['/','/index.html','/styles.css','/app.js','/manifest.webmanifest','/logo-aspch-original.png'];
...
self.addEventListener('push',e=>{
  ...
  const options={body:payload.body||'',icon:payload.icon||'/logo-aspch-original.png',badge:payload.badge||'/logo-aspch-original.png',tag:payload.tag||`mi-aspch-${payload.kind||'notice'}`,renotify:false,data:{url:payload.url||'/?view=home',kind:payload.kind||'general'},actions};
