...
const presentationMode=()=>flag('PRESENTATION_MODE',false);
const presentationWritesAllowed=()=>!presentationMode()||flag('PRESENTATION_ALLOW_REAL_WRITES',false);
...
export function sheetsWriteEnabled(){return presentationWritesAllowed()&&googleEnabled()&&flag('GOOGLE_SHEETS_WRITE',true)}
export function calendarReadEnabled(){return googleEnabled()&&flag('GOOGLE_CALENDAR_READ',true)}
export function calendarWriteEnabled(){return presentationWritesAllowed()&&googleEnabled()&&flag('GOOGLE_CALENDAR_WRITE',false)}
export function gmailOtpSendEnabled(){return !presentationMode()&&googleEnabled()&&flag('GOOGLE_GMAIL_OTP_SEND',flag('GOOGLE_GMAIL_SEND',false))}
export function gmailNotificationSendEnabled(){return !presentationMode()&&googleEnabled()&&flag('GOOGLE_GMAIL_NOTIFICATION_SEND',false)}
