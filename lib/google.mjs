...
export function previewMode(){return flag('PREVIEW_MODE',false)}
...
export function sheetsWriteEnabled(){return !previewMode()&&googleEnabled()&&flag('GOOGLE_SHEETS_WRITE',true)}
export function calendarReadEnabled(){return googleEnabled()&&flag('GOOGLE_CALENDAR_READ',true)}
export function calendarWriteEnabled(){return !previewMode()&&googleEnabled()&&flag('GOOGLE_CALENDAR_WRITE',false)}
export function gmailOtpSendEnabled(){return !previewMode()&&googleEnabled()&&flag('GOOGLE_GMAIL_OTP_SEND',flag('GOOGLE_GMAIL_SEND',false))}
export function gmailNotificationSendEnabled(){return !previewMode()&&googleEnabled()&&flag('GOOGLE_GMAIL_NOTIFICATION_SEND',false)}
export function gmailSendEnabled(){return gmailOtpSendEnabled()||gmailNotificationSendEnabled()}
export function googleCapabilities(){return {enabled:googleEnabled(),previewMode:previewMode(),sheets:{read:sheetsReadEnabled(),write:sheetsWriteEnabled()},calendar:{read:calendarReadEnabled(),write:calendarWriteEnabled()},gmail:{send:gmailSendEnabled(),otp:gmailOtpSendEnabled(),notifications:gmailNotificationSendEnabled()}}}
